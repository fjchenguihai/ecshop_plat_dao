...
/**
 * VAfterSales entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "v_after_sales")
public class VAfterSales implements java.io.Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -689732218L;
	 ...
	 * afterSalesTypeDesc:����
	 */
	@Column(name = "afterSalesTypeDesc", length = 100)
	private String afterSalesTypeDesc;// get afterSalesTypeDesc
  ...
  */     
	...
	/** minimal constructor */
	public VAfterSales(Long afterSalesId) {
		this.afterSalesId = afterSalesId;
	}

	/** full constructor */
	public VAfterSales(Long afterSalesId, String afterSalesNo,
			Integer afterSalesType, Long orderGoodsId, Long orderId,
			Long mallId, String orderNumber, Timestamp afterSalesTime,
			Long goodId, Long goodItemsId, String goodsName, Integer goodNum,
			String goodsPic, Double amount, Long userId, String username,
			Integer status, String remark, Integer isCalculateProfit,
			Timestamp calcTime, String img1, String img2, String img3,
			String img4, Double mallMoney, Double profitMoney,
			Integer mallCheckStatus, Timestamp mallsettlementTime,
			String userLogisticsName, String userLogisticsNo,
			String mallLogisticsName, String mallLogisticsNo,
			String statusDesc, String afterSalesTypeDesc, String mallName) {
		this.afterSalesId = afterSalesId;
