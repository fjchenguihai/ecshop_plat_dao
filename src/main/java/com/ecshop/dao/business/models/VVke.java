...
/**
 * VVke entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "v_vke")
public class VVke implements java.io.Serializable {

	/**
	 * serialVersionUID
	 */
	private static final long serialVersionUID = 2648090L;
	...
	/** minimal constructor */
	public VVke(Long userId) {
		this.userId = userId;
	}

	/** full constructor */
	public VVke(Long userId, Long usertypeId, String username, String realName,
